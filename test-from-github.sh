...
echo ""
echo "Testing VoltageCurrentMAX471SensorCalibratedSerial project from github"
echo ""
...
git clone http://github.com/GreenSense/VoltageCurrentMAX471SensorCalibratedSerial -b $BRANCH && \

cd VoltageCurrentMAX471SensorCalibratedSerial && \
sh init.sh && \
sh build.sh && \
sh upload.sh && \
