...
#  sshpass -p $GARDEN_PASSWORD ssh -o StrictHostKeyChecking=no -t $GARDEN_USER@$GARDEN_HOSTNAME "bash -c 'cd /home/$GARDEN_USER/workspace/GreenSense/Index/sketches/monitor/VoltageCurrentMAX471SensorCalibratedSerial && sh pull-build-and-upload.sh'"
